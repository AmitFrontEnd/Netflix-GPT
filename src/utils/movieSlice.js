...
export const { addNowPlayingMovies, addTrailerInfo, addTopRatedMovies, addPopularMovies, addnowPlayingMoviesError, addtopRatedMoviesError, addpopularMoviesError } = movieSlice.actions
